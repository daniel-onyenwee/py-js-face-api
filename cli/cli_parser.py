...
parser_detect.add_argument("models_dir", type=str, help="Face recognition models location.")
...
parser_recognize.add_argument("models_dir", type=str, help="Face recognition models location.")
